...
public interface RoomMapper {
    ...
    void updateRoomInfo(@Param("order") Order order, @Param("roomId") int roomId);
    ...
    List<Room> selectRoomsByHotelId(@Param("hotelId") Integer hotelId);
    ...
    List<Integer> getRoomNumber(@Param("id") int roomId);

    @Select(value = "select id from hotel.Room where room_type=#{order.roomType} and hotel_id=#{order.hotelId} and breakfast=#{order.breakfast} ")
    int getRoomId(@Param("order") Order order);
